// Name: David Mu
// Student Number: 163298219
// Email: dmu2@myseneca.ca
// Section: NEE

// ==================== Code for responsive navbar ====================
let myMenu = document.querySelector('.menu-icon');
let myNavbar = document.querySelector('.nav-links');

// Making the navbar responsive using a menu icon
myMenu.addEventListener('click', function() {
    myNavbar.classList.toggle('open-menu');
    myMenu.classList.toggle('move');
});

// The navbar should collapse on small screens when scrolled
window.onscroll = () => {
    myNavbar.classList.remove('open-menu');
    myMenu.classList.remove('move');
}
